			...
			library.getUsersListByRole(profileId, role).then(function(list){
				if(list != undefined){
					if(list.length > 1){
						...
						var spFunc = '<a href="#" style="color:blue" onClick="app.openSubprocess("'+profileId+'","'+ processId +'", "'+ processSeq +'", "'+ processName +'", "'+ subprocessID +'", "'+ subprocessSEQ+'", "'+ subprocessUUID +'", "'+ process_ValidDate +'", "'+ process_CurrentStepName +')">click here</a>';
						console.log('spFunc');
						console.log(spFunc);
