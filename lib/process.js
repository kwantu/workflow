		...
		switch(prerequisite._type) {
			...
			case 'processInstances':
				try {
					...
					var subject = count(getSubProcessCount(id, _WFInstance));
...
function getSubProcessCount(id, _WFInstance){
	
	return JSON.xpath("/subprocesses[id eq '"+id+"']",_WFInstance,{});
