    ...
    return new Promise(function(resolve, reject) {
        ...
        if (prerequisite.check.numberProcessInstances != undefined) {
            ...
            dao.get(fileName).then(function(file) {
                ...
                if(subjectValueCalculated == undefined && prerequisite.check.variable.allowBlank != undefined && prerequisite.check.variable.allowBlank){
                ...
                if(prerequisite.check.variable.type == "blankAllowed"){
                    var success = util.success('Variable Pre-requisites passed.', {});
                    resolve(success);
                }
                else{
