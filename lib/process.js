                ...
                case 'worker':
                    ...
                    switch (propertyExists(action.method.worker, workerPossibleItems)) {
                        ...
                        case 'service':
                            ...
                            workerObject.groupKey = subProcess.groupKey;
                            
                            var populateParam = function(p){
                                if(actionItem.method.worker.service.params == undefined || p == actionItem.method.worker.service.params.length){
                                    var URL = DOMAIN.replace('/exist/rest', "") + actionItem.method.worker.service.url;
