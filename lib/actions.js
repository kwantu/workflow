            ...
            return new Promise(function(resolve, reject) {
                ...
                processParams(configParam).then(function(paramsArray) {
                    ...
                    if(paramsArray.length == 0){
                        ((methodName)(callbackSuccess, callbackFailure, spUUID));
                    }
                    else if(paramsArray.length == 1){
                        ((methodName)(paramsArray[0].paramValue, callbackSuccess, callbackFailure, spUUID));
                    }
                    else if(paramsArray.length == 2){
                        ((methodName)(paramsArray[0].paramValue, paramsArray[1].paramValue, callbackSuccess, callbackFailure, spUUID));
                    }
                    else if(paramsArray.length == 3){
                        ((methodName)(paramsArray[0].paramValue, paramsArray[1].paramValue, paramsArray[2].paramValue, callbackSuccess, callbackFailure, spUUID));
                    }
                    else if(paramsArray.length == 4){
                        ((methodName)(paramsArray[0].paramValue, paramsArray[1].paramValue, paramsArray[2].paramValue, paramsArray[3].paramValue, callbackSuccess, callbackFailure, spUUID));
                    }
                    else if(paramsArray.length == 5){
                        ((methodName)(paramsArray[0].paramValue, paramsArray[1].paramValue, paramsArray[2].paramValue, paramsArray[3].paramValue, paramsArray[4].paramValue, callbackSuccess, callbackFailure, spUUID));
                    }
                    else if(paramsArray.length == 6){
                        ((methodName)(paramsArray[0].paramValue, paramsArray[1].paramValue, paramsArray[2].paramValue, paramsArray[3].paramValue, paramsArray[4].paramValue, paramsArray[5].paramValue, callbackSuccess, callbackFailure, spUUID));
                    }
                    else if(paramsArray.length == 7){
                        ((methodName)(paramsArray[0].paramValue, paramsArray[1].paramValue, paramsArray[2].paramValue, paramsArray[3].paramValue, paramsArray[4].paramValue, paramsArray[5].paramValue, paramsArray[6].paramValue, callbackSuccess, callbackFailure, spUUID));
                    }
                    else if(paramsArray.length == 8){
                        ((methodName)(paramsArray[0].paramValue, paramsArray[1].paramValue, paramsArray[2].paramValue, paramsArray[3].paramValue, paramsArray[4].paramValue, paramsArray[5].paramValue, paramsArray[6].paramValue, paramsArray[7].paramValue, callbackSuccess, callbackFailure, spUUID));
                    }
