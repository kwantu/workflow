...
var variables = (function() {
    ...
    return {
        ...
        setVariable: function(setVariable, uuid, _WFInstance) {

            return new Promise(function(resolve, reject) {

                var dataValue = helper.getNodeValue(setVariable.data, _WFInstance, uuid);
                ...
                switch (scope) {
                    case 'profile':
                        ...
                        dao.get(profileVariableFileName).done(function(data) {
