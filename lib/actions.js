            ...
            return new Promise(function(resolve, reject) {
                    ...
                    var getRecipients = function(notification) {
                        ...
                        return new Promise(function(resolve, reject) {
                            ...
                            else if (notification.recipients.email != undefined) {

                                recipients.email = notification.recipients.email;
                                resolve(recipients);

                            }
                            else if (notification.recipients.sms != undefined) {

                                recipients.sms = notification.recipients.sms;
                                resolve(recipients);

                            }
                            else{
                                console.log("Notification - no recipient error ");
                                reject("Notification - no recipient error ");
                            }
...
var worker = (function() {
    ...
    return {
        ...
        setScheduler: function(setScheduler, _WFInstance, uuid) {

            return new Promise(function(resolve, reject) {

                if(setScheduler.transition == undefined){
                    reject({
                        "isError": true,
                        "message": "Config issue in setScheduler action."
                    });
                }
                else{

                    var workerAction = "setScheduler";
                    ...
                    workerObject.action = {
                        setScheduler: {
                            "type": "transition",
                            dueDateValue: setScheduler.dueDate.after.value,
                            dueDateUnit: setScheduler.dueDate.after.unit,
                            stepId: setScheduler.transition.stepId,
                            transitionId: setScheduler.transition.transitionId
                        }
                    }
