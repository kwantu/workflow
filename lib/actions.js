...
var worker = (function() {
    ...
    return {
        ...
        getWorkerWrapper: function() {
            ...
            var wrapper = {
                "source": ((app.SCOPE.txn == undefined || managetransactions == false || app.SCOPE.workOnline == true)?"remote":""),
                "type": "workerObject",
                "_id": "",
                ...
                "senderUserId": "",
                "subProfileId": "",
                "parentTransactionId": ((app.SCOPE.txn == undefined || (managetransactions == true && app.SCOPE.workOnline == false)) ? "" : app.SCOPE.txn.transactionId),
                "action": {
