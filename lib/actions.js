            ...
            return new Promise(function(resolve, reject) {
                    ...
                    var getRecipients = async function(notification) {
                        ...
                        for(var r = 0; r < notification.recipients.length; r++){
                            ...
                            else if (notification.recipients[r].email != undefined) {

                                item.email = notification.recipients[r].email;
                                recipients.push(item);

                            }
                            else if (notification.recipients[r].sms != undefined) {

                                item.sms = notification.recipients[r].sms;
                                recipients.push(item);
