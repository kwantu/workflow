                    ...
                    var getRecipients = async function(notification) {
                        ...
                        for(var r = 0; r < notification.recipients.length; r++){
                            ...
                            if (notification.recipients[r].role != undefined) {
                                ...
                                var stepId = notification.recipients[r].stepAssigneeFromStep.stepId;
                                ...
                                if(isRepeat){
                                    ...
                                    for(var rp = 0; rp < repeat.length; rp++){
                                        ...
                                        if(rptModel != undefined && rptModel instanceof String && rptModel.length > 0){
                                    ...
                                    if(model != undefined && model instanceof String && model.length > 0){
                                        emailIds.push(model);
                                    }
                                }
