    ...
    return {
        ...
        createCommunity: function(_def, uuid, _WFInstance) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                if(JSON.xpath("/indicators[category/term eq 'Community']/_id", app.SCOPE.workflow, {}).length == 0){
                    throw Error("SP WORK"); 
                }
    ...
    return {
        ...
        createAppDefinition: function(_def, uuid, _WFInstance) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                if(JSON.xpath("/indicators[category/term eq 'Application']/_id", app.SCOPE.workflow, {}).length == 0){
                    throw Error("SP WORK"); 
                }
    ...
    return {
        ...
        unlockPeriod: function(_def, uuid, _WFInstance) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                if(JSON.xpath("/indicators[id eq '" + PERIOD_SET_ID + "']/instances/uuid", subprocessObject, {}).length == 0){
                    throw Error("SP WORK"); 
                }
        ...
        lockPerformanceModel: function(_def, uuid, _WFInstance) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                if(JSON.xpath("/indicators[id eq '" + PERFORMANCE_SET_ID + "']/instances/uuid", subprocessObject, {}).length == 0){
                    throw Error("SP WORK"); 
                }
        ...
        sendNotificationWorker: function(notification, _WFInstance, uuid) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                */
                ...
                if(JSON.xpath("/indicators[_id eq '" + app.profile._id + "']/title", app.SCOPE.workflow, {}).length == 0){
                    throw Error("SP WORK"); 
                }
                ...
                if(JSON.xpath("/indicators[_id eq '" + subprofileId + "']/title", app.SCOPE.workflow, {}).length == 0){
                    throw Error("SP WORK"); 
                }
        ...
        reAssignmentNotification: function(notification, _WFInstance, uuid, user) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                */
                ...
                var stepConfigObject = JSON.xpath("/processes/subProcesses[_id eq '" + subProcessObject.id + "']/steps[_id eq '" + stepObject.id + "']", app.SCOPE.workflow.config, {})[0];
                if(JSON.xpath("/subprocesses[_id eq '" + subProcessObject.id + "']", app.SCOPE.workflow, {}).length == 0){
                    throw Error("SP WORK"); 
                }
                action.notification.keys.step.stepName = app.getNameByLang(stepConfigObject.name);
...
var worker = (function() {
    ...
    return {
        ...
        getWorkerWrapper: function() {
            ...
            var wrapper = {
                "source": ((app.SCOPE.txn == undefined || managetransactions == false || LOCAL_SETTINGS.workOnline == true)?"remote":""),
                "type": "workerObject",
                "_id": "",
                ...
                "senderUserId": "",
                "subProfileId": "",
                "parentTransactionId": ((app.SCOPE.txn == undefined || (managetransactions == true && LOCAL_SETTINGS.workOnline == false)) ? "" : app.SCOPE.txn.transactionId),
                "action": {
