                    ...
                    var getRecipients = async function(notification) {
                        ...
                        for(var r = 0; r < notification.recipients.length; r++){
                            ...
                            if (notification.recipients[r].role != undefined) {
                                ...
                                var emailIds = [];
                                if(isRepeat){
                                    var rptModel = model[notification.recipients[r]?.email?.field?.code.split(":")[2]][notification.recipients[r]?.email?.field?.code.split(":")[3]][notification.recipients[r]?.email?.field?.code.split(":")[4]];
                                ...
                                var smsNumbers = [];
                                if(isRepeat){
                                    var rptModel = model[notification.recipients[r]?.sms?.field?.code.split(":")[2]][notification.recipients[r]?.sms?.field?.code.split(":")[3]][notification.recipients[r]?.sms?.field?.code.split(":")[4]];
                                    for(var rp = 0; rp < repeat.length; rp++){
