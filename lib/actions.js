    ...
    return {
        ...
        setScheduler: function(setScheduler, _WFInstance, uuid) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                var dueDate = moment();
                if (setScheduler.dueDate != undefined) {
                    if (setScheduler.dueDate.after != undefined) {
                        dueDate = moment(dueDate).add(setScheduler.dueDate.after.value, setScheduler.dueDate.after.unit);
                    }
                }
                workerObject.action = {
                    setScheduler: {
                        dueDate: dueDate.format("YYYY-MM-DD") + " 00:00:00",
                        transition: setScheduler.transition
