...
"use strict";function getLanguageMessage(e){var a=service.getLanguage(),t=e.i18n[a];return t}function getNodeValue(e,a,t){return new Promise(function(r,i){if(void 0!=e.value){var s="string";s=void 0!=e.value.datatype.dataType?e.value.datatype.dataType:e.value.datatype;var o=e.value.data;r("number"==s?Number(o):"string"==s?o:"integer"==s?parseInt(o):"decimal"==s?parseFloat(o):"date"==s||"dateTime"==s?o:o)}else if(void 0!=e.indicatorUUID){var n=null,c=JSON.xpath("/subprocesses[_id eq '"+t+"']",a,{})[0];0==c.indicators.length?n=JSON.xpath("/indicators[category/term eq '"+e.indicatorUUID.indicatorSetId+"']/_id",a,{})[0]:(n=JSON.xpath("/indicators[id eq '"+e.indicatorUUID.indicatorSetId+"']/instances/uuid",c,{})[0],void 0==n&&(n=JSON.xpath("/indicators[category/term eq '"+e.indicatorUUID.indicatorSetId+"']/_id",a,{})[0])),r(n)}else if(void 0!=e.indicator){var n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+e.indicator.indicatorSetId+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],p="/model/pending/data/"+e.indicator.indicatorSetId+"/"+e.indicator.elementId,l=JSON.xpath("/config/processes/subProcesses[_id eq /subprocesses[_id eq '"+t+"']/id]/type",a,{})[0],u=JSON.xpath("count(/instance/processes/subProcesses[id = /subprocesses[_id eq '"+t+"']/id])",a,{})[0]+1;if(l==PROCESS_TYPE_SUBPROFILE){var v=library.getSubprofileSubprocessIds();u=JSON.xpath("count(/instance/processes/subProcesses[id = /subprocesses[_id eq '"+t+"']/id and uuid = "+v+"])",a,{})[0]+1}var S=replaceAll(p,"#SEQUENCE#",u),f=JSON.xpath("/subprocesses[_id eq '"+t+"']/dates/valid",a,{})[0],b="'"+f+"'",h=replaceAll(S,"#END_DATE#",b),m=replaceAll(h,"[.]","/"),O=JSON.xpath(m,d,{})[0];void 0!=e.indicator.addString&&""!=e.indicator.addString&&(O+=e.indicator.addString),r(O)}else if(void 0!=e.system)r("ERROR: Unimplemented system type found.");else if(void 0!=e.variable)if(void 0!=e.variable.profile){var x=e.variable.profile,N=a.profile,g=N+":variables";dao.get(g).then(function(s){if(void 0!=e.variable.type)"count"==e.variable.type?r(s[e.variable.name].length):i("ERROR: Profile variables type implementation - Case not found");else{for(var o=s,n=""==x?[]:x.split(/['"\[\].]+/),c=0;c<n.length;c++)""!=n[c]&&(o=o[n[c]]);var d=o;if(void 0==d)i("Variable not found");else if("object"==typeof d){var p=function(){return new Promise(function(r,i){var s=0;if(void 0==e.variable.periodic||void 0==e.variable.periodic.seq){var o=JSON.xpath("/config/processes/subProcesses[_id eq /subprocesses[_id eq '"+t+"']/id]/type",a,{})[0];if(s=JSON.xpath("count(/instance/processes/subProcesses[id = /subprocesses[_id eq '"+t+"']/id])",a,{})[0]+1,o==PROCESS_TYPE_SUBPROFILE){var n=library.getSubprofileSubprocessIds();s=JSON.xpath("count(/instance/processes/subProcesses[id = /subprocesses[_id eq '"+t+"']/id and uuid = "+n+"])",a,{})[0]+1}r(s)}else getNodeValue(e.variable.periodic.seq,a,t).then(function(e){r(e)}).catch(function(e){i(e)})})},l=function(){return new Promise(function(r,i){var s="value";void 0!=e.variable.periodic&&void 0!=e.variable.periodic.value?getNodeValue(e.variable.periodic.value,a,t).then(function(e){r(e)}).catch(function(e){i(e)}):r(s)})};p().then(function(e){l().then(function(a){var t="/"+x+"["+e+"]/"+a,i=JSON.xpath(t,s,{})[0];r(i)}).catch(function(e){i(e)})}).catch(function(e){i(e)})}else"string"==typeof d&&r(d)}}).catch(function(e){i("ERROR: Profile variables not found")})}else if(void 0!=e.variable.subProfile){var x=e.variable.subProfile,I=app.profile.subprofileId;void 0!=e.variable.subprofileId&&""!=e.variable.subprofileId&&(I=e.variable.subprofileId);var g=I+":variables";dao.get(g).then(function(s){for(var o=s,n=""==x?[]:x.split(/['"\[\].]+/),c=0;c<n.length;c++)""!=n[c]&&(o=o[n[c]]);var d=o;if(void 0==d)i("Variable not found");else if("object"==typeof d){var p=0;if(void 0==e.variable.periodic||void 0==e.variable.periodic.seq){var l=JSON.xpath("/config/processes/subProcesses[_id eq /subprocesses[_id eq '"+t+"']/id]/type",a,{})[0];if(p=JSON.xpath("count(/instance/processes/subProcesses[id = /subprocesses[_id eq '"+t+"']/id])",a,{})[0]+1,l==PROCESS_TYPE_SUBPROFILE){var u=library.getSubprofileSubprocessIds();p=JSON.xpath("count(/instance/processes/subProcesses[id = /subprocesses[_id eq '"+t+"']/id and uuid = "+u+"])",a,{})[0]+1}}else p=getNodeValue(e.variable.periodic.seq,a,t);var v="value";void 0!=e.variable.periodic&&void 0!=e.variable.periodic.value&&(v=getNodeValue(e.variable.periodic.value,a,t));var S="/"+x+"["+p+"]/"+v,f=JSON.xpath(S,s,{})[0];r(f)}else"string"==typeof d&&r(d)}).catch(function(e){i("ERROR: sub Profile variables not found")})}else i("ERROR: Unimplemented profile type found.");else if(void 0!=e.indicatorWrapper){var q=e.indicatorWrapper.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],J=replaceAll(e.indicatorWrapper.path,"[.]","/"),p="/"+J,_=JSON.xpath(p,d,{})[0];r(_)}else if(void 0!=e.calculated){for(var _="",E=e.calculated.separator,P=0;P<e.calculated.elements.length-1;P++){var R=e.calculated.elements,y=["fromRepeat","elementProperty","constantValue","elementWrapper","currentDate","randomDigits","profileObjectElement","profileObjectWrapper","currentFinancialYear","scopeVariable","xpath"];switch(propertyExists(R[P],y)){case"elementProperty":var q=R[P].elementProperty.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],J=replaceAll(R[P].elementProperty.elementId,"[.]","/"),p="/model/pending/data/"+q+"/"+J,D=JSON.xpath(p,d,{})[0];_=_+D+E;break;case"constantValue":var D=R[P].constantValue.value;_=_+D+E;break;case"scopeVariable":var k=R[P].scopeVariable,D="";"#USER_ID"==k?D=_lclx.SUBSCRIPTIONS.userId:"#USERNAME"==k?D=_lclx.SESSION.username:"#FIRSTNAME"==k?D=_lclx.SESSION.firstName:"#LASTNAME"==k&&(D=_lclx.SESSION.lastName),D.length>0&&(_=_+D+E);break;case"elementWrapper":var q=R[P].elementWrapper.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],J=replaceAll(R[P].elementWrapper.elementId,"[.]","/"),p="/"+J,D=JSON.xpath(p,d,{})[0];_=_+D+E;break;case"currentDate":_=_+formatDate(new Date)+E;break;case"randomDigits":var A=R[P].randomDigits.digits,w=Math.random(),U=Math.pow(10,A),V=w*U^0;_=_+V+E;break;case"profileObjectElement":var q=R[P].profileObjectElement.indicatorSetId,d=JSON.xpath("/indicators[category/term eq 'appProfile']",app.SCOPE.workflow,{})[0],J=replaceAll(R[P].profileObjectElement.elementId,"[.]","/"),p="/model/pending/data/"+q+"/"+J,D=JSON.xpath(p,d,{})[0];_=_+D+E;break;case"profileObjectWrapper":var q=R[P].profileObjectWrapper.indicatorSetId,d=JSON.xpath("/indicators[category/term eq 'appProfile']",app.SCOPE.workflow,{})[0],J=replaceAll(R[P].profileObjectWrapper.wrapperElementId,"[.]","/"),p="/"+J,D=JSON.xpath(p,d,{})[0];_=_+D+E;break;case"currentFinancialYear":var W=R[P].currentFinancialYear.startDate,j=R[P].currentFinancialYear.startMonth,F=(new Date).getFullYear()+"-"+j+"-"+W;_=_+F+E;break;case"fromRepeat":var q=R[P].fromRepeat.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],J=replaceAll(R[P].fromRepeat.path,"[.]","/"),p="/model/pending/data/"+q+"/"+J,M="";if("validDate"==R[P].fromRepeat.filter){var Y=JSON.xpath("/subprocesses[_id eq '"+t+"']",a,{})[0],T=Y.dates.valid;M="[enddate eq '"+T+"']/"}p=p+M+replaceAll(R[P].fromRepeat.element,"[.]","/");var D=JSON.xpath(p,d,{})[0];_=_+D+E;break;case"xpath":if(void 0!=R[P].xpath.indicatorSetId&&R[P].xpath.indicatorSetId.length>0){var q=R[P].xpath.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],D=JSON.xpath(R[P].xpath.expr,d,{})[0];_=_+D+E;break}var D=JSON.xpath(R[P].xpath.expr,a,{})[0];_=_+D+E;break;default:i("No method found from implemented list.")}}var P=e.calculated.elements.length-1,R=e.calculated.elements,y=["fromRepeat","elementProperty","constantValue","elementWrapper","currentDate","randomDigits","profileObjectElement","profileObjectWrapper","currentFinancialYear","scopeVariable","xpath"];switch(propertyExists(R[P],y)){case"elementProperty":var q=R[P].elementProperty.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],J=replaceAll(R[P].elementProperty.elementId,"[.]","/"),p="/model/pending/data/"+q+"/"+J,D=JSON.xpath(p,d,{})[0];_+=D;break;case"constantValue":var D=R[P].constantValue.value;_+=D;break;case"scopeVariable":var k=R[P].scopeVariable,D="";"#USER_ID"==k?D=_lclx.SUBSCRIPTIONS.userId:"#USERNAME"==k?D=_lclx.SESSION.username:"#FIRSTNAME"==k?D=_lclx.SESSION.firstName:"#LASTNAME"==k&&(D=_lclx.SESSION.lastName),D.length>0&&(_+=D);break;case"elementWrapper":var q=R[P].elementWrapper.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],J=replaceAll(R[P].elementWrapper.elementId,"[.]","/"),p="/"+J,D=JSON.xpath(p,d,{})[0];_+=D;break;case"currentDate":_+=formatDate(new Date);break;case"randomDigits":var A=R[P].randomDigits.digits,w=Math.random(),U=Math.pow(10,A),V=w*U^0;_+=V;break;case"profileObjectElement":var q=R[P].profileObjectElement.indicatorSetId,d=JSON.xpath("/indicators[category/term eq 'appProfile']",app.SCOPE.workflow,{})[0],J=replaceAll(R[P].profileObjectElement.elementId,"[.]","/"),p="/model/pending/data/"+q+"/"+J,D=JSON.xpath(p,d,{})[0];_+=D;break;case"profileObjectWrapper":var q=R[P].profileObjectWrapper.indicatorSetId,d=JSON.xpath("/indicators[category/term eq 'appProfile']",app.SCOPE.workflow,{})[0],J=replaceAll(R[P].profileObjectWrapper.wrapperElementId,"[.]","/"),p="/"+J,D=JSON.xpath(p,d,{})[0];_+=D;break;case"currentFinancialYear":var W=R[P].currentFinancialYear.startDate,j=R[P].currentFinancialYear.startMonth,F=(new Date).getFullYear()+"-"+j+"-"+W;_+=F;break;case"fromRepeat":var q=R[P].fromRepeat.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],J=replaceAll(R[P].fromRepeat.path,"[.]","/"),p="/model/pending/data/"+q+"/"+J,M="";if("validDate"==R[P].fromRepeat.filter){var Y=JSON.xpath("/subprocesses[_id eq '"+t+"']",a,{})[0],T=Y.dates.valid;M="[enddate eq '"+T+"']/"}p=p+M+replaceAll(R[P].fromRepeat.element,"[.]","/");var D=JSON.xpath(p,d,{})[0];_+=D;break;case"xpath":if(void 0!=R[P].xpath.indicatorSetId&&R[P].xpath.indicatorSetId.length>0){var q=R[P].xpath.indicatorSetId,n=JSON.xpath("/subprocesses[_id eq '"+t+"']/indicators[id eq '"+q+"']/instances/uuid",a,{})[0],d=JSON.xpath("/indicators[_id eq '"+n+"']",a,{})[0],D=JSON.xpath(R[P].xpath.expr,d,{})[0];_=_+D+E;break}var D=JSON.xpath(R[P].xpath.expr,a,{})[0];_=_+D+E;break;default:i("No method found from implemented list.")}r(_)}else if(void 0!=e.subProcess)if(void 0!=e.subProcess.path){for(var C=e.subProcess.path,L=C.split("."),B="",P=0;P<L.length;P++)B=B+"['"+L[P]+"']";for(var c=JSON.xpath("/subprocesses[_id eq '"+t+"']",a,{})[0],Q=c,z=""==B?[]:B.split(/['"\[\].]+/),G=0;G<z.length;G++)""!=z[G]&&(Q=Q[z[G]]);var _=Q;r(_)}else void 0!=e.subProcess.stepUser})}function replaceAll(e,a,t){return"function"!=typeof e.replace&&(console.log(a+" "+t),console.log(e)),e.replace(new RegExp(a,"g"),t)}function formatDate(e){var a=e.getDate(),t=e.getMonth(),r=e.getFullYear();return a+"-"+t+"-"+r}function compare(e,a,t){switch(a){case">":return e>t;case"<":return e<t;case">=":return e>=t;case"<=":return e<=t;case"==":return void 0==e&&(e=""),e===t;case"!=":return e!==t}}module.exports={getLanguageMessage:getLanguageMessage,getNodeValue:getNodeValue,compare:compare};
